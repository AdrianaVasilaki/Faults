...
var style_Photos_tagged_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if ("" !== null) {
        ...
        function rules_Photos_tagged_11(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_Photos_tagged_11rule0_eval_expression(context)) {
        ...
        var style = rules_Photos_tagged_11(feature, value);
        ;
